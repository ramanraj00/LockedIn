    ...
    >
      <div className="w-full px-6 md:px-12 flex flex-col sm:flex-row justify-between items-center z-10 gap-6 mb-8 md:mb-12">
        ...
        <div className="flex items-center gap-4">
          <a href="https://github.com/ramanraj00/LockedIn" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-300 hover:text-white hover:bg-white/20 hover:scale-110 transition-all duration-300 shadow-sm">
          ...
          <a href="https://x.com/ramanteen15?s=20" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-300 hover:text-white hover:bg-white/20 hover:scale-110 transition-all duration-300 shadow-sm">
      ...
      <div 
        className="relative w-full flex justify-center items-end select-none pointer-events-none mt-auto overflow-hidden"
        style={{
