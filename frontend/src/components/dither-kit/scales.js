 ...
 */
export function computeBands(data, keys, stackType) {
  ...
  const series = d3Stack()
    ...
    .offset(stackType === "percent" ? stackOffsetExpand : (undefined))(data)
 ...
 */
export function buildYScale(min, max, plotHeight) {
