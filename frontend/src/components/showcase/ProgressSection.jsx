...
const ProgressSection = () => {
  return (
    <div className="w-screen min-h-screen md:h-screen bg-[#FAF9F6] flex flex-col justify-center relative overflow-hidden shrink-0 py-20 md:py-0" id="progress-section">
