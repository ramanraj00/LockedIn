    ...
    <div className="w-screen min-h-screen md:h-screen bg-[#FAF9F6] flex flex-col justify-center relative overflow-hidden shrink-0 py-20 md:py-0" id="architecture-section">
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center relative">
          ...
          <div className="relative w-full py-12 md:py-0 md:aspect-[4/3] bg-white/40 border border-[#E5E3DB] rounded-3xl p-4 md:p-8 flex items-center justify-center shadow-sm">

            {/* Custom Diagram Node Container */}
            <div className="relative w-full max-w-[600px] h-[250px] md:h-[350px] z-10 px-0 md:px-12 mt-8 md:mt-12">
              
              {/* Horizontal Connecting Line */}
              <div className="absolute left-[10%] right-[10%] top-1/2 -translate-y-1/2 h-0 border-t-[2px] border-dashed border-[#8CA8B1] -z-10"></div>
              
              {/* Traveling Dot */}
              <motion.div 
                className="absolute top-1/2 -translate-y-1/2 w-4 h-4 bg-[#5C9EAD] rounded-full shadow-[0_0_12px_rgba(92,158,173,0.8)] z-20"
                animate={{ left: ["10%", "10%", "50%", "90%", "90%"], scale: [0, 1, 1, 1, 0] }}
              ...
              {/* Node 1: Signup */}
              <div className="absolute left-[10%] top-1/2 -translate-y-1/2 flex flex-col items-center group">
              ...
              <div className="absolute left-[50%] top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center group">
                <span className="absolute -bottom-10 md:-bottom-12 font-medium text-[#2C3E50] text-[10px] sm:text-xs md:text-base text-center w-24 md:w-auto whitespace-normal md:whitespace-nowrap leading-tight tracking-wide">Secure Your Vault</span>
              ...
              <div className="absolute right-[10%] top-1/2 -translate-y-1/2 flex flex-col items-center group">
